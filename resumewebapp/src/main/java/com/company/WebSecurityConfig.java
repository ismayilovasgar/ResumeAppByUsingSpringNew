...
//                .authorizeRequests().antMatchers("/sign**").permitAll()
                ...
                .and()
//                .authorizeRequests().antMatchers("/types").hasAnyAuthority("USER", "ADMIN")
//                .and()
//                .authorizeRequests().antMatchers("/categories").hasAnyAuthority("USER", "ADMIN")
//                .and()
//                .authorizeRequests().antMatchers("/expenses").hasAnyAuthority("ADMIN", "USER")
//                .and()
